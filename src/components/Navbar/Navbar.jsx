...
export default function Navbar({cartCount,onCartClick,whatsappNumber}){
  return <nav className="navbar">
    ...
    <div className="nav-links"><a className="active" href="#home">Home</a><a href="#menu">Menu</a><a href="#about">About Us</a><a href="#benefits">Benefits</a><a href="#gallery">Gallery</a><a href="#contact">Contact</a><Link to="/admin">Admin</Link></div>
